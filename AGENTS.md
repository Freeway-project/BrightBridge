...
- When committing graphify output only, use a single-line subject: `chore(graphify): refresh code graph`. Do not add assistant or AI attribution in the message body.
