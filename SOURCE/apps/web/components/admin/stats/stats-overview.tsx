...
import type { StatusCount, TAWorkload } from "@/lib/repositories/contracts"
...
export function StatsOverview({ totalCourses, statusCounts, stuckCount }: Props) {
  ...
  return (
    <div className="grid grid-cols-2 gap-4 lg:grid-cols-4">
      ...
      <StatCard label="Stuck" value={stuckCount} icon="alert-triangle" index={3} sub="needs attention" />
    </div>
  )
}
