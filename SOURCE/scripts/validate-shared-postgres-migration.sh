...
#
# Optional:
#   COUNT_TABLES  Comma-separated table list. Defaults to core CourseBridge tables.

: "${SUPABASE_DATABASE_URL:?SUPABASE_DATABASE_URL is required}"
: "${TARGET_DATABASE_URL:?TARGET_DATABASE_URL is required}"

COUNT_TABLES="${COUNT_TABLES:-profiles,courses,course_assignments,course_status_events,review_sections,review_responses,course_comments,review_invites,organizational_units,org_unit_members,schema_migrations}"
