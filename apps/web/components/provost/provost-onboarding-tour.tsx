  ...
  const tabsInfo = [
    {
      ...
      emoji: "📊",
      subtitle: "Institution-wide Stats",
      meaning: "The central hub for high-level, read-only monitoring of the whole institution.",
      does: [
        "Displays institution-wide KPIs (Total Courses, Completed, In Progress, Stuck/At-Risk).",
        "Visualizes the full pipeline — staging → ready → sent → approved — and the phase breakdown.",
        "Surfaces stuck / at-risk courses that need executive attention.",
        "Shows TA workload distribution across the institution.",
      ],
    ...
    },
    {
      ...
      meaning: "A read-only structural drill-down to inspect any unit or subunit (no editing).",
      does: [
