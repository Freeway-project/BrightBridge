  ...
  return (
    <LampContainer>
      <motion.h1
        ...
        className="mt-8 bg-gradient-to-br from-primary to-primary/50 py-4 bg-clip-text text-center text-4xl font-black uppercase tracking-tighter text-transparent md:text-7xl"
      >
        CourseBridge <br /> Workflow
      </motion.h1>
    </LampContainer>
  );
}
