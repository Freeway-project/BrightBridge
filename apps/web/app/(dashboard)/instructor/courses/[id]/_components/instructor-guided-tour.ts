 ...
 *
 * Each tour step must put the wizard on the right step BEFORE driver tries to
 * spotlight that step's control. We override onNextClick/onPrevClick to
 * (1) change the wizard step, (2) wait two animation frames for React to render,
 * then (3) advance driver — guaranteeing the target element exists.
 */
