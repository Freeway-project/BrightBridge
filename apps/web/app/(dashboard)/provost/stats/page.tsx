...
// Provost stats: institution-wide operational metrics. Reuses the admin stats
// surface but is gated to the global-oversight roles (provost + super_admin).
export default async function ProvostStatsPage() {
  const context = await requireProfile()
  requireAnyRole(context, ["provost", "super_admin"])
  ...
  return (
    <>
      <Topbar
        title="Stats"
        subtitle="Institution-wide operational queue, handoff readiness, and bottlenecks"
